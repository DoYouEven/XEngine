    ...
    if (lHasDeformation)
    {
        ...
        else
        {
            ...
            if (lClusterCount)
            {
                ...
                ComputeSkinDeformation(pGlobalPosition, lMesh, pTime, lVertexArray, pPose);             //need
            }
        }
									 ...
									 FbxPose* pPose)
{
	...
	else if(lSkinningType == FbxSkin::eBlend)
	{
		...
		//ComputeLinearDeformation(pGlobalPosition, pMesh, pTime, lVertexArrayLinear, pPose);            //DELETE
		//ComputeDualQuaternionDeformation(pGlobalPosition, pMesh, pTime, lVertexArrayDQ, pPose);		//DELETE
