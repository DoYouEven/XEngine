...
namespace
{
	...
	const char * SAMPLE_FILENAME = "Pikachu_Run.fbx";
...
SceneObject::SceneObject(const char * pFileName, int pWindowWidth, int pWindowHeight, bool pSupportVBO)
...
bool SceneObject::SetCurrentAnimStack(int pIndex)
{
...
bool SceneObject::SetCurrentCamera(const char * pCameraName)
{
	if (!pCameraName)
	{
		return false;
...
bool SceneObject::SetCurrentPoseIndex(int pPoseIndex)
{
...
void SceneObject::OnTimerClick() const
{
...
void SceneObject::OnReshape(int pWidth, int pHeight)
{
...
void SceneObject::OnKeyboard(unsigned char pKey)
{
...
void SceneObject::OnMouse(int pButton, int pState, int pX, int pY)
{
...
void SceneObject::OnMouseMotion(int pX, int pY)
{
	int motion;
...
void SceneObject::SetSelectedNode(FbxNode * pSelectedNode)
{
	mSelectedNode = pSelectedNode;
	mStatus = MUST_BE_REFRESHED;
}

void SceneObject::SetShadingMode(ShadingMode pMode)
{
	mShadingMode = pMode;
	mStatus = MUST_BE_REFRESHED;
}

void SceneObject::DisplayWindowMessage()
{
...
void SceneObject::DisplayGrid(const FbxAMatrix & pTransform)
{
	glPushMatrix();
...
void SceneObject::SetZoomMode(CameraZoomMode pZoomMode)
{
